...
|-------|-----------|---------|-------|
| Platform | Multi-stack template (Web, Python, Android, Node, optional Lightroom/Rust/Go) | 1.1.1 | Template maintainer repo |
...
- **Template version:** `1.1.1` (see `.template-version`)
