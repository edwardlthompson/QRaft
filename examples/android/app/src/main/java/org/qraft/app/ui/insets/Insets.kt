package org.qraft.app.ui.insets
...
fun NavigationModeProvider(content: @Composable () -> Unit) {
    ...
    if (BuildConfig.DEBUG) {
        ...
        Log.d("QRaft", "navMode=$mode navInsetBottom=${measured}px")
    }
...
fun navigationModeLabelRes(mode: NavigationMode): Int = when (mode) {
    NavigationMode.ThreeButton -> org.qraft.app.R.string.nav_mode_three_button
    NavigationMode.TwoButton -> org.qraft.app.R.string.nav_mode_two_button
    NavigationMode.Gesture -> org.qraft.app.R.string.nav_mode_gesture
    NavigationMode.Unknown -> org.qraft.app.R.string.nav_mode_unknown
}
