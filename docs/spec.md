...
| ID | Story | Acceptance |
|----|-------|------------|
| FR-1 | As a user I encode URL/text/Wi-Fi/vCard/email/SMS/phone/crypto into a QR matrix | Nayuki-backed `:core-qr`; versions 1–40; ECC L/M/Q/H; auto-H with overlays |
| FR-2 | As a user I preview a square QR without stretched modules | `:render` square path; quiet zone ≥ 4; scannability warnings |
